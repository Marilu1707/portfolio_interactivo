...
class HomeDesktop extends StatelessWidget {
          ...
          child: _HomeCard(
            child: Column(
              ...
              children: [
                ...
                const _Dot('Orientación a resultados + mejora de procesos.'),
                if (isMobile) ...[
                  const SizedBox(height: 16),
                  _playButton(context, expanded: true),
                ],
  ...
  Widget _buildPresentationRow() {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: const [
        Icon(Icons.restaurant_menu, size: 48, color: onAccent),
        SizedBox(width: 12),
        Expanded(
          child: Text(
...
class _Chips extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        final maxPillWidth =
            constraints.maxWidth < 600 ? constraints.maxWidth * 0.9 : 320.0;
        return Wrap(
          spacing: 8,
          runSpacing: 8,
          children: items
